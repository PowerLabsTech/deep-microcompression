#!/usr/bin/env python3
"""
NAS board search (training-free ranking)  —  MobileNetV2 / CIFAR-100
==================================================================

Same experiment as the LeNet version, for MobileNetV2 on the ATmega2560
...
Run:
    python experiments/mobilenetv2_cifar100/nas_zeroshot_search.py \
...
BASELINE_CKPT = None  # get_model() downloads the pretrained MobileNetV2
...
def main():
    ...
    if tr:
        ...
        print(f"\n{'='*64}\n  BEST DEPLOYABLE MobileNetV2 (zero-shot search)\n{'='*64}")
