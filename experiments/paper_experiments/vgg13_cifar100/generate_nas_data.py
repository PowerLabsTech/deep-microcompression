#!/usr/bin/env python3
"""
Generate NAS compression data samples for VGG-13 on CIFAR-100.
...
from development.experiments.vgg13   import get_model
...
def main():
    parser = argparse.ArgumentParser(description="NAS data generation: VGG-13/CIFAR-100")
    ...
    # Loads pretrained VGG-13 from torch hub and converts to DMC Sequential
    print("Loading pretrained VGG-13 …")
