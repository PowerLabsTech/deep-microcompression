#!/usr/bin/env python3
"""
NAS board search (training-free ranking)  —  MobileNetV1 / CIFAR-100
==================================================================

Same experiment as the LeNet version, for MobileNetV1 on the ATmega2560
...
Run:
    python experiments/mobilenetv1_cifar100/nas_zeroshot_search.py \
...
# ── Board + recipe (MobileNetV1 / CIFAR-100) ──────────────────────────────────
...
def main():
    ...
    if tr:
        ...
        print(f"\n{'='*64}\n  BEST DEPLOYABLE MobileNetV1 (zero-shot search)\n{'='*64}")
